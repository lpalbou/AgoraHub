...
class Driver:
    ...
    def _briefing_block(self) -> str:
        ...
        try:
            ...
            if "manager" in roles:
                contract += "Manager assignment: organize this task's workers, invite useful challenge, verify each material premise before combining proposals, verify the merged deliverable, and report material decisions or blockers to its director. Current claims/task state already reports progress. "
