...
- Born from a claim/work row in #commons; that row's "channel" field names
  this room so the operator's board can find the work.
...
- DONE = receipt to #commons (result, evidence, follow-ups), then the
  owner closes the room; the operator archives closed rooms later.
"""
